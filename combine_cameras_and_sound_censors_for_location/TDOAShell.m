...
rh=10;
X = Radius * cos(Theta(1:end-1))-0.8*rh;
...
plot3(True_position(:,1),True_position(:,2),True_position(:,3),'bd',Est_position(:,1),Est_position(:,2),Est_position(:,3),'r+','LineWidth',6);
hold on;
plot3(Sen_position(:,1),Sen_position(:,2),Sen_position(:,3),'*g','LineWidth',6);
legend('True Position','Estimated Position','SensorPosition');
